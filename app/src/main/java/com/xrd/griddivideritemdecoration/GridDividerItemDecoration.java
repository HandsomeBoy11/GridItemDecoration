...
//        mOrientation = orientation;
     ...
     */
    public GridDividerItemDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public GridDividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
